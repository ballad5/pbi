...
export const commonStore = defineStore('common', {
  ...
  getters: {
    ...
    isoCountries(): any { return {
      ...
      GN: 'Guinea', GW: 'Guinea-Bissau', GY: 'Guyana', HT: 'Haiti', HM: 'Heard Island & Mcdonald Islands',
      ...
      AE: 'United Arab Emirates', GB: 'United Kingdom', US: 'United States', UM: 'United States Outlying Islands',
